...
RuleTester.describe("check-sql", () => {
  ...
  // TODO: These tests are disabled because they expect PostgreSQL type names (like 'xml', 'inet')
  // to be valid TypeScript types. The tests need to be rewritten to use actual TypeScript types
  // that the plugin infers (like 'unknown', 'string', 'number').
  //
  ...
  //     options: withConnection(connections.withTag),
  //     code: `sql<{ "${colName}": ${colType} }>\`select "${colName}" from type_test\``,
  //   })),
  //   invalid: [],
  // });
  //
  ...
  //         sql<MyType>\`select "${colName}" from type_test\`
  //       `,
  //   })),
  //   invalid: [],
  // });
